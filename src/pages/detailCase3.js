    ...
    return (
      ...
      <ScrollTop>
        ...
        <Reveal effect="fadeIn">
          <Hero className='mainhero' style={{ backgroundImage: "url('./img/projects/big/bg5.png')" }}>
        ...
        <section className='container-fluid' id='detailproject'>
          <div className='row m-2-hor'>
            <div className='col-md-8'>
              ...
              <p className='content'>Design with best touch of excellence</p>
            </div>
