        ...
        <ScrollTop>
          <CaseWrapper>
            <Reveal effect="fadeIn">
              <Hero
                className="mainhero"
                style={{ backgroundImage: "url('./img/projects/big/bg2.png')" }}
              >
            ...
            <section className="container-fluid" id="detailproject">
              <div className="row m-2-hor">
                <div className="col-md-8">
                  ...
                  <p className="content">
                    We are reliable and well know in design homes and offices with state of the heart design.
                  </p>
                </div>
